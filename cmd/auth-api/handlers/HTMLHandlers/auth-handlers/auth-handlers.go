...
const baseHTMLDirectory = "cmd/auth-api/handlers/HTMLHandlers/auth-handlers/html/"

func NewWebAuthHandler(storage *postgres.UsersStorage) *WebAuthHandler {
...
func (wa *WebAuthHandler) AuthorizationHandler(w http.ResponseWriter, r *http.Request) error {
	...
	user := &request.AuthUser{request.GeneralInfo{Email: email, Password: password}}
